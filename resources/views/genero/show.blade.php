...
<head>
    <title>{{ $genero->nome }} - Histórias</title>
    <meta charset="utf-8">
...
<body>
    ...
    <div class="wrap">
                        ...
                        <ul class="navbar-nav mx-auto">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="dropdown04">
                                    ...
                                    <a class="dropdown-item" href="{{ url('/dicas') }}">Plots</a <a class="dropdown-item" href="{{ url('/dicas') }}">Outros</a>
                                </div>
                            </li>
                            <li class="nav-item">
        ...
        <section class="site-section pt-5">
            <div class="container">
                <h2 class="mb-4">Histórias de {{ $genero->nome }}</h2>
