                        ...
                        <ul class="navbar-nav mx-auto">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="dropdown04">
                                    ...
                                    <a class="dropdown-item" href="{{ url('/dicas') }}">Estr utura</a>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" id="username" value="{{ $usuario->name }}" disabled> <!-- Nome de usuário -->
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="email" class="form-control-label">Email</label>
                                    <input class="form-control" type="email" id="email" value="{{ $usuario->email }}" disabled> <!-- Email do usuário -->
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="stories_count" class="form-control-label">Quantidade de histórias publicadas</label>
                                    <input class="form-control" type="number" id="stories_count" value="{{ $usuario->historias->count() }}" disabled> <!-- Contagem de histórias -->
                                </div>
                            </div>
                        </div>
                    </div>
