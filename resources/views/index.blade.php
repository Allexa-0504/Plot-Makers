                        ...
                        <div class="auth-form-light text-left p-5">
                            ...
                            <form class="pt-3">
                                <div class="form-group">
                                    <input type="email" class="form-control form-control-lg" id="exampleInputEmail1" placeholder="Usuário" style="border-radius: 5px; border-color: #847f8b; required">
                                </div>
                                <div class="form-group">
                                    <input type="password" class="form-control form-control-lg" id="exampleInputPassword1" placeholder="Senha" style="border-radius: 5px; border-color: #847f8b; required">
                                </div>
                                <div class="mt-3">
